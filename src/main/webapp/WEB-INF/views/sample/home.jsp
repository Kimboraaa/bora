...
<body>
	...
	<div id="wrap">
		<header class="header cfixed">
			<h1 class="logo">
				<a href=""><img src="/resources/images/logo5.png"
					style="height: 50px" alt=""></a>
			</h1>
			<nav>
				<ul class="gnb">
					<li><a href="/" style="color: #FF8224">HOME</a></li>
		...
		<article class="slider">
			<img src="/resources/images/san.jpg" alt="">
		</article>
				...
				<div class="container">
					<ul class="promo-list">
						<li><a href="#" onclick="return false"> <img
								src="/resources/images/1.jpg" alt="">
								<h3>HOME</h3>
						...
						<li><a href="#" onclick="return false"> <img
								src="/resources/images/4.jpg" alt="">
								<h3>HOME</h3>
								<p>휴면 교육센터 디지털 컨버전스 과정 입니다.</p>
						</a></li>
					</ul>
			...
			<ul class="work-list">
				<li><a href="#" onclick="return false">
						<div class="info">
							<h3>작업1</h3>
							<span>소스/작업1</span>
						</div> <img src="/resources/images/san.jpg" alt="">
				</a></li>
				<li><a href="#" onclick="return false">
						<div class="info">
							<h3>작업1</h3>
		...
		<section class="blog-section">
			<div class="container">
				...
				<ul class="blog-list">
					<li><a href="#" onclick="return false"><img
							src="/resources/images/web1.jpg" alt=""></a> <time
							datetime="2016-10-30">OCT 30, 2016</time> <a href=""><h3>타임스페이스는
								사용자 중심의 웹페이지를 제작하는 회사 입니다.</h3></a></li>
					<li><a href="#" onclick="return false"><img
							src="/resources/images/web2.jpg" alt=""></a> <time
							datetime="2016-10-30">OCT 30, 2016</time> <a href=""><h3>타임스페이스는
								사용자 중심의 웹페이지를 제작하는 회사 입니다.</h3></a></li>
					<li><a href="#" onclick="return false"><img
							src="/resources/images/web3.jpg" alt=""></a> <time
							datetime="2016-10-30">OCT 30, 2016</time> <a href=""><h3>타임스페이스는
								사용자 중심의 웹페이지를 제작하는 회사 입니다.</h3></a></li>
				</ul>
			</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <input class="form-control" placeholder="메세지 내용을 입력해주세요.">
      </div>
