...
body header .row #brand {
	background: url(/resources/images/logo5.png) no-repeat 0% 60%;
	height: 90px;
	width: 200px;
	margin: 0px;
	text-indent: -10000px;
...
<!-- 모든 컴파일된 플러그인을 포함합니다 (아래), 원하지 않는다면 필요한 각각의 파일을 포함하세요 -->
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="/resources/images/sd1.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="item">
      <img src="/resources/images/sd2.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="item">
      <img src="/resources/images/sd3.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="item">
      <img src="/resources/images/sd4.jpg" class="d-block w-100" alt="...">
    </div>
  </div>
...
<span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>
	...
	<section id="contents" class="row">
		<article id="main">
			...
			<ul>
				<li class="clearfix"><img class="col-4"
					src="/resources/images/san.jpg" alt="" width="296" height="206" />
				...
				<li class="clearfix"><img class="col-8 fr last"
					src="/resources/images/san.jpg" alt="" width="620" height="416" />
					<div class="col-4">
		...
		<article id="sub" class="row clearfix">
			...
			<ul>
				<li class="col-3"><img src="/resources/images/san.jpg"
				...
				<li class="col-6 last"><img src="/resources/images/san.jpg"
