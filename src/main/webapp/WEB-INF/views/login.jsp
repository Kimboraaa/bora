...
<script>
   if('${param.msg}' =="fail"){
      alert('로그인에 실패했습니다.! 상세메세지 ${sessionScope["SPRING_SECURITY_LAST_EXCEPTION"].message}');ㄹ
      }
</script>
   <div id="container">
      <!-- location_area -->
            ...
            <fieldset>
               ...
               <ul class="app_list">
                  ...
                  <li class="clear">
                     ...
                     <div class="app_content"><input name="user_id" type="text" class="w100p" id="name_lbl" placeholder="아이디을 입력해주세요"/></div>
                  </li>
                  <li class="clear">
